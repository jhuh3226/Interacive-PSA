...
public class TrackHandPosture : MonoBehaviour
{
            ...
            if (manager.IsJointTracked(userId, iJointIndex))
            {
                ...
                if (posJoint != Vector3.zero)
                {
                    ...
                    if (overlayObject)
                    {
                        ...
                        //added
                        print("overlayObject.position.x" + overlayObject.position.x);
                        print("overlayObject.position.y" + overlayObject.position.y);
                        print("overlayObject.position.z" + overlayObject.position.z);
