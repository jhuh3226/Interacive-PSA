Shader "SkinnedDecals/Tessellated Parallax" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf StandardSpecular finalgbuffer:finalGBuffer exclude_path:forward noshadow noforwardadd vertex:disp tessellate:tessDistance nolightmap
		#pragma target 4.6
